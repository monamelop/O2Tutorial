void DrawPKP(){
  ...
  hRecoPion->SetMarkerSize(1.0);
  hRecoKaon->SetMarkerSize(1.0);
  hRecoProton->SetMarkerSize(1.0);
  ...
  TLegend *leg = new TLegend(0.65, 0.83, 0.94, 0.68);
  leg->SetBorderSize(0);
  ...
  cn->SaveAs("Efficiency_PionKaonProton.pdf");
}